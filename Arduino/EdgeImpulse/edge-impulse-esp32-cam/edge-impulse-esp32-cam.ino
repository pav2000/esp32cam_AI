 ...
 * https://forum.edgeimpulse.com/t/esp32-compile-errors/2604/4
 */
...
//extern bool _jpg2rgb565(const uint8_t *src, size_t src_len, uint8_t * out, jpg_scale_t scale);
...
bool _jpg2rgb565(const uint8_t *src, size_t src_len, uint8_t * out, jpg_scale_t scale)
{
...
bool capture() {
  ...
  _jpg2rgb565(fb->buf, fb->len, rgb565, JPG_SCALE_2X); // scale to half size
