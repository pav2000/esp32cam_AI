...
const char* ssid = "NIIIZMERENIA";
const char* password = "Hydra1314";
...
//    return ESP_FAIL;
  ...
  sprintf(full_filename, "/spiffs/selfie_f_%d.jpg", (int)file_number);
...
//  file_number++;
  ...
  sprintf(full_filename, "/spiffs/selfie_t_%d.jpg", (int)file_number);
...
//  delay(5000);
  ...
  sprintf(addtobrowser, "added:selfie_t_%d.jpg", (int)file_number);
  file_number++;
  File file = SPIFFS.open("/test.txt", "w");
